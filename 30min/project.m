...
load GHI1.mat;
%GHI=GHI';
max1=max(GHI1(1:8760));
min1=min(GHI1(1:8760));
for i=1:length(GHI1),
...
%training dataset
input= GHI1(1:5840-output_i);
output= GHI1(1+output_i:5840);

%validation dataset
input1= GHI1(5841-output_i:8760-output_i);
output1= GHI1(5841:8760);

%testing dataset
input2= GHI1(8761-output_i:11680-output_i);
output2= GHI1(8761:11680);
